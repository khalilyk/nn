...
export const DEFAULT_CONTENT: SiteContent = {
  ...
  projects: [
    ...
    { name: "Voyage Concierge", sub: "Exclusive journeys, extraordinary experiences.", city: "Dubai", year: "2025", cat: "Branding", desc: "Voyage Concierge came to us with a clear mission: to redefine how the world experiences travel - seamless, intimate, and utterly bespoke. We translated that vision into a refined brand identity: an elegant logo, a warm editorial tone, and visual cues drawn from vintage luggage tags, global coordinates and handwritten notes.\n\nThe brand story speaks to travellers who value the unseen, the tailored, the quietly spectacular. We built a motto, brand language and moodboards that evoke wanderlust without the clichés. Because for Voyage Concierge, the destination isn't just a place - it's a feeling.", img: "/projects/voyage/nn-voyage.jpg", images: ["/projects/voyage/nn-voyage.jpg", "/projects/voyage/nn-voyagestamps1.jpg", "/projects/voyage/nn-voyagetote1.jpg", "/projects/voyage/nn-voyageshirt.jpg", "/projects/voyage/nn-voyagenote.jpg"] },
