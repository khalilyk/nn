            ...
            >
              ...
              <div className="absolute inset-0 flex items-center justify-center px-[9%] pointer-events-none">
                <div className="font-editorial text-[#0A0A0A] leading-relaxed space-y-2.5 max-w-md" style={{ fontSize: "clamp(0.6rem, 1.15vw, 0.85rem)" }}>
                  <p>Hanging in our office and a favourite of ours, as it shows Abraham didn&apos;t wait to know who was standing before him. He saw guests approaching and immediately focused on making them comfortable, welcome, and cared for.</p>
