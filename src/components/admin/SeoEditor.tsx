    ...
    <div className="space-y-3">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
        ...
        <div className="rounded-3xl bg-white shadow-sm p-5 space-y-5">
          ...
          <label className="block">
            <span className="block text-[10px] tracking-[0.16em] uppercase text-black/40 mb-1.5">Social share image URL (OG)</span>
            <input value={seo.ogImage} onChange={(e) => set("ogImage", e.target.value)} placeholder="/nn-header-poster.jpg" className="w-full bg-transparent border-b border-black/15 pb-2 text-[14px] text-[#0A0A0A] outline-none focus:border-black/50 transition-colors" />
          </label>
